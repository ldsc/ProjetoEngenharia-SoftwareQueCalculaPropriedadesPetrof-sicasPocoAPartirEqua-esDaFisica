...
class CLitologia
{
  protected:
    ...
    vector <double> litoCarbonato;
    vector <double> profCarbonato;
  ...
  public:
    ...
    double Get_ProfCarbonato(int indice) {return profCarbonato[indice];};
    vector <double> & Get_ProfCarbonato_vector () {return profCarbonato;};
